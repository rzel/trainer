...
class DataAugmentationCifar10NormalizeSmall(object):
    ...
    @reset
    def train(img):
        da(img).convert_to_image_format(1.0).resize_image_randomly(1.0, size_range=(32, 36)).crop_picture_randomly(1.0, sizes=(32, 32)).normalize_picture(1.0, value=10.).cutout(0.5, sizes=(16, 16)).horizontal_flipping(0.5).convert_to_chainer_format(1.0)
        return da.x, da.info
...
class DataAugmentationCifar10NormalizeMiddle(object):
    ...
    @reset
    def train(img):
        da(img).convert_to_image_format(1.0).resize_image_randomly(1.0, size_range=(64, 68)).crop_picture_randomly(1.0, sizes=(64, 64)).normalize_picture(1.0, value=10.).cutout(0.5, sizes=(32, 32)).horizontal_flipping(0.5).convert_to_chainer_format(1.0)
        return da.x, da.info
...
class DataAugmentationCifar10NormalizeBig(object):
    ...
    @reset
    def train(img):
        da(img).convert_to_image_format(1.0).resize_image_randomly(1.0, size_range=(128, 132)).crop_picture_randomly(1.0, sizes=(128, 128)).normalize_picture(1.0, value=10.).cutout(0.5, sizes=(64, 64)).horizontal_flipping(0.5).convert_to_chainer_format(1.0)
        return da.x, da.info
...
class DataAugmentationCifar10NormalizeBigger(object):
    ...
    @reset
    def train(img):
        da.convert_to_image_format(img).resize_image_randomly(1.0, size_range=(256, 512)).crop_picture_randomly(1.0, sizes=(224, 224)).normalize_picture(1.0, value=10.).cutout(0.5, sizes=(112, 112)).horizontal_flipping(0.5).convert_to_chainer_format(1.0)
        return da.x, da.info
...
class DataAugmentationCifar10NormalizeHuge(object):
    ...
    @reset
    def train(img):
        da(img).convert_to_image_format(1.0).resize_image_randomly(1.0, size_range=(299, 512)).crop_picture_randomly(1.0, sizes=(299, 299)).normalize_picture(1.0, value=10.).cutout(0.5, sizes=(114, 114)).horizontal_flipping(0.5).convert_to_chainer_format(1.0)
        return da.x, da.info
